...
Still open, and can only close against the real thing: an actual Supabase project (pooled-connection-string behavior specifically), a real restaurant-to-VPS network hop, and a genuine reboot/long-uptime run of the VPS process under PM2.
