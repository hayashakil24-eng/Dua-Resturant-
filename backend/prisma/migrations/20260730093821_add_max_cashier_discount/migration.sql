...
CREATE TABLE "new_AppSettings" (
    ...
    "maxCashierDiscountPercent" REAL NOT NULL DEFAULT 0,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_AppSettings" ("attendanceDeviceIp", "attendanceDevicePort", "gstEnabled", "gstRate", "id", "updatedAt", "whatsappReportEnabled", "whatsappReportHour", "whatsappReportLastSentClosingId", "whatsappReportRecipient") SELECT "attendanceDeviceIp", "attendanceDevicePort", "gstEnabled", "gstRate", "id", "updatedAt", "whatsappReportEnabled", "whatsappReportHour", "whatsappReportLastSentClosingId", "whatsappReportRecipient" FROM "AppSettings";
