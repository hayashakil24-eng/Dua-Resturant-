...
INSERT INTO "new_PendingHandover" ("amount", "fromName", "id", "initiatedAt", "reason", "rejectReason", "resolvedAt", "resolvedBy", "shiftId", "status", "toName", "toRole") SELECT "amount", "fromName", "id", "initiatedAt", "reason", "rejectReason", "resolvedAt", "resolvedBy", "shiftId", "status", "toName", "toRole" FROM "PendingHandover";
